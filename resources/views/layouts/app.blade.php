...
<head>
    ...
    <title>Pandawa Music Studio</title>
    <meta name="description" content="Pandawa Music Studio">
...
<footer class="site-footer">
    <div class="footer-inner bg-white">
        <div class="row">
            <div class="col-sm-6">
                Copyright &copy; 2019 Pandawa Music Studio
            </div>
            <div class="col-sm-6 text-right">
                Designed by <a href="#">Pandawa</a>
            </div>
        </div>
    </div>
</footer>
